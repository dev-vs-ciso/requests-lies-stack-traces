...
function credentials() {
  ...
  console.log(dim(`  Lab: poke the API with malformed requests and read what the errors leak.`));
  console.log(dim(`  Try:  curl "${URL}/api/appointments?sort=nope"  (after logging in)\n`));
}
...
function menu() {
  console.log(bold("\n━━ Module 2 · Error Handling & Disclosure ━━━━━━━━━━━"));
