...
function credentials() {
  ...
  console.log(dim(`  Capstone: an 'agent-built' API. Tests are green (npm test). Find the holes.`));
  console.log(dim(`  Scoreboard:  option 7) Check my work  lists which vulns are still open.\n`));
}
