...
async function main() {
  ...
  // Module 3 trophy: a sensitive appointment buried DEEP. Created last, so it gets
  // the highest id and sits at the very end of the offset-paginated feed — page-1
  // browsing never finds it; only a full enumeration walk does.
