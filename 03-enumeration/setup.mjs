...
function credentials() {
  ...
  console.log(dim(`  Lab: enumerate the clinic-wide feed, find the trophy buried deep.`));
  console.log(dim(`  Try:  curl -b cookies.txt "${URL}/api/directory/appointments?limit=50&offset=0"\n`));
}
...
function menu() {
  console.log(bold("\n━━ Module 3 · Pagination & Enumeration ━━━━━━━━━━━━━━"));
