...
// Access control is CORRECT in this module (Module 1's IDOR is fixed here): every
// handler enforces ownership. This module's sin is elsewhere — in how errors are
// reported. See src/routes/search.ts and the error handler in src/app.ts.
